...
for run in runs:
    ...
    file_path = f"./Attention_StackLSTM/Full fnc-1 corpus/5 Fold Train/Incorporating features/{run.features}/fold{fold_count}"
    ...
    for train_index, test_index in kf.split(X, y):
        ...
        fold_count += 1
        save_path = f"./Attention_StackLSTM/Full fnc-1 corpus/5 Fold Train/Incorporating features/{run.features}/fold{fold_count}"
        checkpoint_path = f"./Attention_StackLSTM/Full fnc-1 corpus/5 Fold Train/Incorporating features/{run.features}/fold{fold_count}/checkpoint"
