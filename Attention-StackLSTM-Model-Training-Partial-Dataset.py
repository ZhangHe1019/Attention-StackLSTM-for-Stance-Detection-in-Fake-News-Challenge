...
for run in runs:
    ...
    for train_index, test_index in kf.split(X, y):
        ...
        fold_count += 1
        save_path = f"./Attention_StackLSTM/Partial fnc-1 corpus/Model Training/fold{fold_count}"
        checkpoint_path = f"./Attention_StackLSTM/Partial fnc-1 corpus/Model Training/fold{fold_count}/checkpoint"
