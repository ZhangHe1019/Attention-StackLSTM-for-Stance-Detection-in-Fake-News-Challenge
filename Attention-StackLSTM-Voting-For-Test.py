...
for run in runs:
    ...
    path = f"./Attention_StackLSTM/Full fnc-1 corpus/Model Training/parameters"
    ...
    for train_index, test_index in kf.split(X, y):
        ...
        fold_count += 1
        checkpoint_path = f"./Attention_StackLSTM/Full fnc-1 corpus/Model Training/parameters/fold{fold_count}/checkpoint/fold{fold_count}.pth.tar"
